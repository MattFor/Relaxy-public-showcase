...
export default {
    ...
    description: 'Adds yours or the specified user\'s profile picture to the \'delete this trash\' meme format.',
    cooldown: 5,
    ...
    async run(client, message, args, guild, interaction) {
        ...
        return client.send(interaction ? 1 : message.channel, null, null, [
            new Discord.AttachmentBuilder(await new DIG.Trash().getImage(member.displayAvatarURL({ dynamic: true, size: 4096, extension: 'png' })), 'trash.png')
        ])
    }
}