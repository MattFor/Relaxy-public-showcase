...
export default {
    ...
    description: 'Adds yours or the specified user\'s profile picture to the \'this, this is beautiful\' meme template.',
    /**
     * @param {Relaxy} client 
    ...
    async run(client, message, args, guild, interaction) {
        ...
        return client.send(interaction ? 1 : message.channel, null, null, [
            new Discord.AttachmentBuilder(await new DIG.Beautiful().getImage(member.displayAvatarURL({ dynamic: true, size: 4096, extension: 'png' })), 'perfect.png'
            )])
    }
}