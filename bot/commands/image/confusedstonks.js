...
export default {
    ...
    description: 'Adds yours or the specified user\'s profile picture to the \'confused stonks \' meme template.',
    ...
    async run(client, message, args, guild, interaction) {
        ...
        return client.send(interaction ? 1 : message.channel, null, null, [
            new Discord.AttachmentBuilder(await new DIG.ConfusedStonk().getImage(member.displayAvatarURL({ dynamic: true, size: 4096, extension: 'png' })), 'confused.png')
        ])
    }
}