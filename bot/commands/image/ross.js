...
export default {
    ...
    description: 'Adds yours or the specified user\'s profile picture to a Bob Ross painting.',
    ...
    async run(client, message, args, guild, interaction) {
        ...
        return client.send(interaction ? 1 : message.channel, null, null, [
            new Discord.AttachmentBuilder(await new DIG.Bobross().getImage(member.displayAvatarURL({ dynamic: true, size: 4096, extension: 'png' })), 'ross.png')
        ])
    }
}