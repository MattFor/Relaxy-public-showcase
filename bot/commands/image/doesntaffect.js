...
export default {
    ...
    usage: '=doesntaffect user',
    description: 'Adds profile picture to meme template.',
    ...
    async run(client, message, args, guild, interaction) {
        ...
        return client.send(interaction ? 1 : message.channel, null, null, [
            new Discord.AttachmentBuilder(await new DIG.Affect().getImage(member.displayAvatarURL({ dynamic: true, size: 4096, extension: 'png' })), 'doesntaffect.png')
        ])
    }
}